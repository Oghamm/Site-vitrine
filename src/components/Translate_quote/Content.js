                    ...
                    <div className="row">
                        <div className="col-12">
                            <h4 className="intro__title section-title">
                                La plateforme de traduction pour tous vos contenus
                            </h4>
                        </div>

                        <div className="col-12">
                            <p className="intro__text">Décrivez vos besoins en traduction, nos conseillers reviendront
                            ...
                            <div className="contact__form no-border">
                                <form onSubmit={handleFormSubmit}>
                                    ...
                                    <div className="contact__form no-border">
                                        <form>
                                            <div className="form-group">
                                                <label htmlFor="lastName">Vos besoins en traduction</label>
                                                <textarea
                                                    id="link"
                                                    name="lien_du_site"
                                                    required={true}
